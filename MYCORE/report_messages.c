...
void ReportClamberLegState()
{
  ...
  SendFrame.Data.floats_ts[0] = leg_data_feedback.leg_state_[0];
	...
	SendFrame.Data.floats_ts[3] = leg_angle.original_pitch;
		...
		case 2:
  SendFrame.Data.floats_ts[0] = leg_data_feedback.send_leg_height_change_flag;	
	SendFrame.Data.floats_ts[1] = leg_data_feedback.send_leg_change_flag;	
	SendFrame.Data.floats_ts[2] = leg_state_data.leg_state_number;
  SendFrame.Data.floats_ts[3] = leg_data_feedback.crossd_step_state;//Pi*(decelerate_distance - distance_a)/2/(float)time_all/CalRealSpeed(speed_max);
		messager_mark = 3;	
			break;
...
COM_Frame SendFrame;
	...
	{
		case 0:
	  SendFrame.Data.floats_ts[0] = machineA_general_data.target_distance;
	  SendFrame.Data.floats_ts[1] = machineA_general_data.step_number_left;
	  SendFrame.Data.floats_ts[2] = DM_MoveInfo.distance_data.distance_all;//relative_position_y;
	  SendFrame.Data.floats_ts[3] = DM_MoveInfo.distance_data.target_distance;
    messager_mark = 1;		
			break;
		
		case 1:
		SendFrame.Data.floats_ts[0] = GetLaseFieldAngle();
	  SendFrame.Data.floats_ts[1] = location_data.laser1_data;
	  SendFrame.Data.floats_ts[2] =(short)(location_data.laser1_data * arm_cos_f32(GetLaseFieldAngle()*angle_to_radian_radio));
		SendFrame.Data.floats_ts[3] =  (short)(location_data.laser1_position.y);
		messager_mark = 2;	
			break;
	  ...
	  SendFrame.Data.floats_ts[2] = location_data.laser1_data;
 		SendFrame.Data.floats_ts[3] = location_data.motor_position.highleg_y;//Pi*(decele
		messager_mark = 3;	
			break;
